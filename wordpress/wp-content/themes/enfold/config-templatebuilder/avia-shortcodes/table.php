	...
	class avia_sc_table extends aviaShortcodeTemplate
	{
			...
			*/
			function pricing_table($table_rows, $atts, $meta)
			{
				...
				$output  =	"";		
				$output .= "<div class='avia-table main_color avia-pricing-table-container avia-table-".self::$table_count." ".$meta['el_class']."'>";
			...
			*/
			...
			{	
				...
				$output  = "<table class='avia-table avia-data-table avia-table-".self::$table_count." ".$meta['el_class']."'>";
